...
def test_job_recommendations():
    ...
    print("Testing job recommendations with specific job skills...")
    ...
    # Test with no job skills (fallback to generic)
    print("Testing with no job skills (generic recommendations)...")
    empty_job_data = {
        'required_skills': {},
        'optional_skills': {},
        'requirements': {
    ...
    print("Generic Job Recommendations:")
